...
package com.modestmaps
{
    ...
    public class TweenMap extends Map
	{
	   ...
	   /** Pan by px and py, in panDuration (used by panLeft, panRight, panUp and panDown) */
        ...
        public function zoomByAboutDirty(zoomDelta:Number, targetPoint:Point=null, duration:Number=-1):void
        {   
            if (duration < 0) duration = panAndZoomDuration;
            if (!targetPoint) targetPoint = new Point(mapWidth/2, mapHeight/2);        	
	   ...
	   /**
        ...
        public function zoomTo (z:Number, l:Location=null, t:Point = null, d:Number = -1):void
        {
            if (z > grid.zoomLevel) {
                var v:Number = z - grid.zoomLevel;
                panAndZoomBy(v, l, t, d);   
            } else if (z < grid.zoomLevel) {
                v = z - grid.zoomLevel;
                trace(-1 / v);
                panAndZoomBy(-1 / v, l, t, d);   
            } else if (z == grid.zoomLevel){
                panTo(l);
            }
        }
