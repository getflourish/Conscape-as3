package flare.vis
{
	 ...
	 * <ul>
	 *  <li>A <code>Data</code> instance containing <code>DataTouchSprite</code>
	 ...
	 * </p>
	 * 
	 * <p>All visual elements are contained within <code>layers</code> TouchSprite.
	 ...
	 */
	public class Visualization extends TouchSprite
	{	
		// -- Properties ------------------------------------------------------
		
		private var _bounds:Rectangle = new Rectangle(0,0,500,500);
		
		private var _layers:TouchSprite; // sprite for all layers in visualization
		private var _marks:TouchSprite;  // sprite for all visualized data items
		private var _labels:TouchSprite; // (optional) sprite for labels
		...
		public function get layers():TouchSprite { return _layers; }
		
		/** TouchSprite containing the <code>DataTouchSprite</code> instances. */
		public function get marks():TouchSprite { return _marks; }
		
		/** TouchSprite containing a separate layer for labels. Null by default. */
		public function get labels():TouchSprite { return _labels; }
		public function set labels(l:TouchSprite):void {
			if (_labels != null)
		 ...
		 *  <code>DataTouchSprite</code> elements in this visualization.
		...
		public function Visualization(data:Data=null, axes:Axes=null) {
			addChild(_layers = new TouchSprite());
			_layers.name = "_layers";
			
			_layers.addChild(_marks = new TouchSprite()); 
			_marks.name = "_marks";
		...
		public function setHitArea(evt:Event=null):void
		{
			...
			var hit:TouchSprite = getChildByName("_hitArea") as TouchSprite;
			if (hit == null) {
				hit = new TouchSprite();
				hit.name = "_hitArea";
				addChildAt(hit, 0);
